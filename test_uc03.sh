...
for pp in -it -ie -ibe -ite; do
   $PGM $pp   2>&1 | diff test_uc03_bad_params_out.txt -
done
$PGM -ib 'abc' -e   2>&1 | diff test_uc03_bad_params_out.txt -
# Base only
s=AV:A/AC:M/Au:S/C:C/I:P/A:C
$PGM --base $s  2>&1 | diff test_uc03_base_out.txt -
# Adding Temporal
s=AV:A/AC:M/Au:S/C:C/I:P/A:C
f=test_uc03_temporal
$PGM -it --base $s < ${f}_in.txt 2>&1 | diff ${f}_out.txt -
# Adding Environmental
s=AV:A/AC:M/Au:S/C:C/I:P/A:C
f=test_uc03_environmental
