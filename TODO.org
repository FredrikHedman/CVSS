* <2026-05-08 Fri> Findings from partition/ValueError/dataclass/print cleanup [1/4]
  ...
  4) [ ] **`clarg: dict[str, Any]` → `argparse.Namespace` or `TypedDict`** —
...
* <2026-05-08 Fri> Findings from Protocol / dict-comprehension refactors [3/4]
  ...
  4) [ ] **`clarg: dict[str, Any]` → use `argparse.Namespace` directly** —
