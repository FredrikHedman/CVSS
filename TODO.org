...
* <2014-03-08 Sat>
** DONE PEP8 checking
** TODO Different scores need refactoring [/]
...
** TODO test_vulnerability.py och vulnerability.md should move to tests [0/2]
   - [ ] How should the doctests import?
   - [ ] How cna these imports be made location independent?
** TODO README.md needs to be updated to reflect new structure
