* <2026-05-08 Fri> Refactor findings from type annotation work [0/7]
  - [ ] **MetricValue → @dataclass(frozen=True) or NamedTuple**
  ...
  - [ ] **Unify *_SCORE strings and *_metrics() data (DRY)**
  ...
  - [ ] **display_score argument shapes → dataclass or TypedDict**
  ...
  - [ ] **lambda/map → list comprehensions in vulnerability.py**
