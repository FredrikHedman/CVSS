* <2026-05-08 Fri> Findings after cast/error-handling/ScoreEntry/debug-print cleanup [2/4]
  ...
  3) [ ] **`guard-then-catch` pattern in `process_cmd_line_base` and `…_vulnerability`** —
