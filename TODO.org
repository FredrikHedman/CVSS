* <2026-05-08 Fri> Findings from partition/ValueError/dataclass/print cleanup [0/4]
  1) [ ] **Remove dead `if __name__ == "__main__": doctest.testmod()` blocks** —
...
* <2026-05-08 Fri> Findings from Protocol / dict-comprehension refactors [2/4]
  ...
  3) [ ] **Dead `if __name__ == "__main__": doctest.testmod()` blocks** —
