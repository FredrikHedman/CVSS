* <2026-05-08 Fri> Findings after override/@TypedDict/annotation cleanup [1/4]
  ...
  2) [ ] **`except Exception` → specific exception types in `cvss.py`** —
...
* <2026-05-08 Fri> Findings from partition/ValueError/dataclass/print cleanup [2/4]
