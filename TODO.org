* <2026-05-09 Sat> Findings after mutation/typed-args/guard/verbose-entries cleanup [0/4]
  1) [ ] **`process_cmd_line_base` and `…_vulnerability` accept `CvssArgs` but only
