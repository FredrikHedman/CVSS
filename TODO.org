* <2026-05-08 Fri> Findings from Protocol / dict-comprehension refactors [0/4]
  ...
  2) [ ] **`part.split(":")[0]: part.split(":")[1]` double split** — The new
...
* <2026-05-08 Fri> Findings from argparse / dataclass / DRY refactors [2/3]
