"""Unit tests for cvss2 interactive input selection."""

from unittest.mock import patch

import pytest

from cvss2.cvss_input import read_metrics, select_metric_value
from cvss2.vulnerability import base_metrics
