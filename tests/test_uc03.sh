...
PGM=cvss
# Bad key
$PGM -ib 'a:b/c:d' 2>&1 | diff tests/test_uc03_bad_key_out2.txt -
# Empty key
$PGM -ib 'a:b/:d' 2>&1 | diff tests/test_uc03_bad_key_out2.txt -
# Empty value
$PGM -ib 'a:/c:d' 2>&1 | diff tests/test_uc03_bad_key_out2.txt -
# Empty component
$PGM -ib 'a:b//c:d' 2>&1 | diff tests/test_uc03_empty_out.txt -
# Incorrect value
